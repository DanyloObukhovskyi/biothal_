                ...
                <div class="panel-body">
                    <form action="#" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab-option" data-toggle="tab">Опции</a></li>
                            <li><a href="#tab-recurring" data-toggle="tab">Периодичность</a></li>
                            <li><a href="#tab-discount" data-toggle="tab">Скидка</a></li>
                            <li><a href="#tab-special" data-toggle="tab">Акция</a></li>
                            <li><a href="#tab-image" data-toggle="tab">Изображения</a></li>
                            <li><a href="#tab-reward" data-toggle="tab">Бонусы</a></li>
                            <li><a href="#tab-design" data-toggle="tab">Дизайн</a></li><li><a href="#tab-apt" data-toggle="tab">Вкладки</a></li>
                        </ul>
                        <div class="tab-content">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="language1">
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="product_description[1][meta_title]" value="Маска-пленка – незаменимое средство для глубокого очищения и отшелушивания кожи." placeholder="Мета-тег Title" id="input-meta-title1" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="product_description[1][meta_description]" rows="5" placeholder="Мета-тег Description" id="input-meta-description1" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="input-meta-keyword1">Мета-тег Keyword</label>
                                            <div class="col-sm-10">
                                                <textarea name="product_description[1][meta_keyword]" rows="5" placeholder="Мета-тег Keyword" id="input-meta-keyword1" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="input-tag1"><span data-toggle="tooltip" title="теги разделяются запятой">Теги товара</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" name="product_description[1][tag]" value="" placeholder="Теги товара" id="input-tag1" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input style="width: 20%; display:inline" ENGINE="text" name="entry_1" value="" placeholder="Заголовок 1" id="input-entry_1" class="form-control" />
                                        <input style="width: 20%; display:inline" type="text" name="entry_text_1" value="" placeholder="Значение 1" id="input-entry_text_1" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-entry_2">Поле 2</label>
                                    <div class="col-sm-10">
                                        <input style="width: 20%; display:inline" type="text" name="entry_2" value="" placeholder="Заголовок 2" id="input-entry_2" class="form-control" />
                                        <input style="width: 20%; display:inline" type="text" name="entry_text_2" value="" placeholder="Значение 2" id="input-entry_text_2" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-entry_3">Поле 3</label>
                                    <div class="col-sm-10">
                                        <input style="width: 20%; display:inline" type="text" name="entry_3" value="" placeholder="Заголовок 3" id="input-entry_3" class="form-control" />
                                        <input style="width: 20%; display:inline" type="text" name="entry_text_3" value="" placeholder="Значение 3" id="input-entry_text_3" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="model" value=" Очищающая маска для лица Конопля Водоросли" placeholder="Модель" id="input-model" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-sku"><span data-toggle="tooltip" title="SKU или код производителя">Краткое описание</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="sku" value="Маска-пленка на основе конопляного масла и морских водорослей эффективно очищает поры от загрязнений и излишков кожного сала, уменьшает воспаления, выравнивает цвет лица." placeholder="Краткое описание" id="input-sku" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-upc"><span data-toggle="tooltip" title="Универсальный код товара">Англ.название</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="upc" value="Cannabis Seaweed Cleansing Mask" placeholder="Англ.название" id="input-upc" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-ean"><span data-toggle="tooltip" title="Европейский код товара">Артикул</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="ean" value="137" placeholder="Артикул" id="input-ean" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-jan"><span data-toggle="tooltip" title="Японский код товара">Объем</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="jan" value="1265" placeholder="Объем" id="input-jan" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-isbn"><span data-toggle="tooltip" title="Международный стандарт номера книги">ISBN</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="isbn" value="" placeholder="ISBN" id="input-isbn" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-mpn"><span data-toggle="tooltip" title="Номер производителя">Старая цена</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mpn" value="1265" placeholder="Старая цена" id="input-mpn" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-location">Расположение</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="location" value="" placeholder="Расположение" id="input-location" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-price">Цена</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="price" value="759" placeholder="Цена" id="input-price" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-tax-class">Налог</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="quantity" value="25" placeholder="Количество" id="input-quantity" class="form-control" />
                                        <!-- NeoSeo Exchange 1c - begin -->
                                        <!-- NeoSeo Exchange 1c - end -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-minimum"><span data-toggle="tooltip" title="Минимальное количество товара в заказе (меньше данного кол-ва товара, добавление в корзину будет запрещено )">Минимальное количество</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="minimum" value="1" placeholder="Минимальное количество" id="input-minimum" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-subtract">Вычитать со склада</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-stock-status"><span data-toggle="tooltip" title="Статус показывается, когда товара нет на складе">Отсутствие на складе</span></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Необходима доставка</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="keyword" value="-ochishhajushhaja-maska-dlja-lica-konoplja-vodorosli" placeholder="SEO URL" id="input-keyword" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-date-available">Дата поступления</label>
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                            <input type="text" name="date_available" value="2020-02-29" placeholder="Дата поступления" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
                    ...
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-length">Размеры (Д x Ш x В)</label>
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <input type="text" name="length" value="0.00000000" placeholder="Длина" id="input-length" class="form-control" />
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="text" name="width" value="0.00000000" placeholder="Ширина" id="input-width" class="form-control" />
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="text" name="height" value="0.00000000" placeholder="Высота" id="input-height" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-length-class">Единица измерения длины</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-weight">Вес</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="weight" value="0.00000000" placeholder="Вес" id="input-weight" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-weight-class">Единица измерения веса</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sort_order" value="1" placeholder="Порядок сортировки" id="input-sort-order" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-links">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="code_1c" value="8d4e9ad1-b166-11ea-ba82-3417ebd478d7" placeholder="Код 1С" id="input-code_1c" class="form-control" />
                                    </div>
                                </div>
                                <!-- NeoSeo Exchange 1c - end -->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-manufacturer"><span data-toggle="tooltip" title="(Автозаполнение)">Производитель</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="manufacturer" value="" placeholder="Производитель" id="input-manufacturer" class="form-control" />
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-category"><span data-toggle="tooltip" title="(Автозаполнение)">Показывать в категориях</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="category" value="" placeholder="Показывать в категориях" id="input-category" class="form-control" />
                                        <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                                            <div id="product-category33"><i class="fa fa-minus-circle"></i> Для лица                      <input type="hidden" name="product_category[]" value="33" />
                                            </div>
                                            <div id="product-category66"><i class="fa fa-minus-circle"></i> Для лица &gt; Маски                      <input type="hidden" name="product_category[]" value="66" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-filter"><span data-toggle="tooltip" title="(Автозаполнение)">Фильтры</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="filter" value="" placeholder="Фильтры" id="input-filter" class="form-control" />
                                        <div id="product-filter" class="well well-sm" style="height: 150px; overflow: auto;">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Магазины</label>
                                    <div class="col-sm-10">
                                        <div class="well well-sm" style="height: 150px; overflow: auto;">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="product_store[]" value="0" checked="checked" />
                                                    Основной магазин                                              </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-download"><span data-toggle="tooltip" title="(Автозаполнение)">Загрузки</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="download" value="" placeholder="Загрузки" id="input-download" class="form-control" />
                                        <div id="product-download" class="well well-sm" style="height: 150px; overflow: auto;">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip" title="(Автозаполнение)">Рекомендуемые товары</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="related" value="" placeholder="Рекомендуемые товары" id="input-related" class="form-control" />
                            ...
                            <div class="tab-pane" id="tab-attribute">
                                <div class="table-responsive">
                                    <table id="attribute" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td colspan="2"></td>
                                            <td class="text-left"><button type="button" onclick="addAttribute();" data-toggle="tooltip" title="Добавить" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-recurring">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                        <tr>
                                            <td class="text-left">Профиль периодичности</td>
                                        ...
                                        <tr>
                                            <td colspan="2"></td>
                                            <td class="text-left"><button type="button" onclick="addRecurring()" data-toggle="tooltip" title="Добавить" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-discount">
                                <div class="table-responsive">
                                    <table id="discount" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td colspan="6"></td>
                                            <td class="text-left"><button type="button" onclick="addDiscount();" data-toggle="tooltip" title="Добавить" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-image">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-left"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="https://biothal.com.ua/image/cache/catalog/maska-dlja-lica-konoplja-vodorosli-100x100.jpg" alt="" title="" data-placeholder="https://biothal.com.ua/image/cache/no_image-100x100.png" /></a><input type="hidden" name="image" value="catalog/maska-dlja-lica-konoplja-vodorosli.jpg" id="input-image" /></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-reward">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-points"><span data-toggle="tooltip" title="Количество баллов для покупки товара. Поставьте 0, чтобы товар нельзя было приобрести за бонусные баллы.">Баллы</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="points" value="0" placeholder="Баллы" id="input-points" class="form-control" />
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td class="text-left">Группа клиентов</td>
                                            <td class="text-right">Бонусные баллы</td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                            ...
                            <div class="tab-pane" id="tab-apt">
                                <div class="tab-content">
                                    <ul class="nav nav-tabs" id="languages_apt">
                                        <li><a href="#language_apt1" data-toggle="tab"><img src="{{ Storage::disk('public')->url('image/en-gb.png')}}" title="English" /> English</a></li>
                                    </ul>
