    ...
    export default {
        ...
        data() {
            return {
                ...
                isCertificate: false,
                images: [
                    '/storage/img/img/certificates/1-min.jpg',
                    '/storage/img/img/certificates/2-min.jpg',
                    '/storage/img/img/certificates/3-min.jpg',
                    '/storage/img/img/certificates/4-min.jpg',
                    '/storage/img/img/certificates/5-min.jpg',
                    '/storage/img/img/certificates/6-min.jpg',
                    '/storage/img/img/certificates/7-min.jpg',
                    '/storage/img/img/certificates/8-min.jpg',
                    '/storage/img/img/certificates/9-min.jpg',
                    '/storage/img/img/certificates/10-min.jpg',
                    '/storage/img/img/certificates/11-min.jpg',
                    '/storage/img/img/certificates/12-min.jpg',
                ],
                index: null
            }
        },
