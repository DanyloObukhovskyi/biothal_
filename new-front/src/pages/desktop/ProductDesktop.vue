...
import {mapActions, mapGetters} from "vuex";
    ...
    export default {
      ...
      this.$analytics.fbq.event( 'AddToCart', {
          value: product.quantity * this.productData["currency"], currency: 'USD', content_ids: this.productData["id"], content_type: 'product', content_category: this.category['sub_category']['slug'], : "'" + this.productData["id"] + "'"
      })
