...
<div class="container-fluid free_delivery" style="background-color: #000000; height: content-box; padding: 5px">
    <div class="justify-content-center">
        <div style="color: #ffffff; text-align: center">Бесплатная доставка от 1500 ГРН <svg style="margin: 10px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
