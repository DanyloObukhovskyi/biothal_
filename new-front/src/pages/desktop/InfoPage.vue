    ...
    export default {
        ...
        data() {
            return {
                ...
                isCertificate: false,
                images: [
                    '/storage/img/img/certificate/1-min.jpg',
                    '/storage/img/img/certificate/2-min.jpg',
                    '/storage/img/img/certificate/3-min.jpg',
                    '/storage/img/img/certificate/4-min.jpg',
                    '/storage/img/img/certificate/5-min.jpg',
                    '/storage/img/img/certificate/6-min.jpg',
                    '/storage/img/img/certificate/7-min.jpg',
                    '/storage/img/img/certificate/8-min.jpg',
                    '/storage/img/img/certificate/9-min.jpg',
                    '/storage/img/img/certificate/10-min.jpg',
                    '/storage/img/img/certificate/11-min.jpg',
                    '/storage/img/img/certificate/12-min.jpg',
                ],
                index: null
            }
        },
