    ...
    <div class="block-product-base-info">
      ...
      <div class="block-product-base-info__info">
        ...
        <div class="info-description">
          Маска оказывает мгновенное увлажняющее действие, разглаживая кожу и повышая ее эластичность и упругость.
          Создает на коже защитную пленку, которая предохраняет от потери влаги и негативного воздействия внешних
          факторов.
        </div>
        ...
        <div class="info-count">
          ...
          <v-text-field hide-details single-line class="info-count__input" v-model.number="count_good">
            ...
            <div @click="incrementCountGood" slot="append-outer" :style="{'background-color': variables.basecolor, color: '#ffffff'}"
        ...
        <div class="info-pay-control">
          ...
          <div class="info-pay-control__buy-fast" :disabled="!validPhoneInput">
            <the-mask v-model="phone" type="tel" class="info-pay-control__buy__input" v-bind="maskOptions" :style="{color: validPhoneInput ? 'white' : 'black'}" />
          </div>
