...
<section class="footerMobile">
    ...
    <div class="container-fluid" style="background-color: #b9bebf; height: content-box; padding: 5px">
        <div class="container cont">
            ...
            <div style="text-align: right; padding-right: 20px"><svg style="color: #000000; margin-top: 15px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gift" viewBox="0 0 16 16">
    ...
    <div class="container-fluid" style="background-color: #ffffff; height: content-box; padding: 20px">
        <div class="present" >
            <div style="color: #6e7072">Электронная почта</div>
    ...
    <div class="container">
        <div class="cont">
            ...
            <div style="text-align: right;">
                ...
                <svg style="width: 2.5em; height: 1.7em; margin-top: 20px; margin-bottom: 20px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg>
                <svg style="width: 2.5em; height: 1.7em; margin-top: 20px; margin-bottom: 20px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
