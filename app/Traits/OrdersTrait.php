...
trait OrdersTrait
{
    ...
    public function prepareXmlArray ($orders) {
        ...
        foreach ($orders as $order) {
            ...
            $orderType = $order['order_type_id'] === 1 ? 7 : 8;

            $xmlBody["ЗначенияРеквизитов"]["ЗначениеРеквизита"][] = [
                "Наименование" => "СтатусЗаказа",
                "Значение" => $orderType
            ];

            $xmlBody["ЗначенияРеквизитов"]["ЗначениеРеквизита"][] = [
                "Наименование" => "ПочтовыйИндекс",
                "Значение" => 'Пусто'
            ];
            ...
            $xmlBody["ЗначенияРеквизитов"]["ЗначениеРеквизита"][] = [
                "Наименование" => "СпособОплаты",
                "Значение" => $order['order_type']['title']
            ];

            $xmlBody["ЗначенияРеквизитов"]["ЗначениеРеквизита"][] = [
                "Наименование" => "ТелефонРабочий",
